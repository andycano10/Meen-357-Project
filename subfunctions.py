# -*- coding: utf-8 -*-
"""
Created on Wed Sep 11 12:54:15 2024
...
# Check exceptions    
    ...
    Fnet = F_net(w, terr_angle, rover, planet, Crr)
...
def simulate_rover(rover, planet, experiment, end_event):
    ...
    # Solve IVP
    solut = solve_ivp(dyn_func,[timespan[0],timespan[-1]], y_0, method = 'RK45', events=event)
